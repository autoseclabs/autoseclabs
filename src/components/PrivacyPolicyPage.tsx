    ...
    <div className="privacy-page">
      ...
      <nav className="privacy-nav">
        <div className="container">
          <Link to="/" className="logo">AutoSec Labs</Link>
        ...
        <div className="container">
          <div className="privacy-policy">
            ...
            <div data-custom-class="body">
              ...
              <div><span style={{color: 'rgb(127, 127, 127)'}}><strong><span style={{fontSize: '15px'}}><span data-custom-class="subtitle">Last updated September 07, 2025</span></span></strong></span></div>
              <div><br /></div>
              <div><br /></div>
              <div><br /></div>
                ...
                <span style={{color: 'rgb(127, 127, 127)'}}>
                  <span style={{color: 'rgb(89, 89, 89)', fontSize: '15px'}}>
                    <span data-custom-class="body_text">
                      This Privacy Notice for <strong>AutoSecLabs</strong> (<strong>"we,"</strong> <strong>"us,"</strong> or <strong>"our"</strong>), describes how and why we might access, collect, store, use, and/or share (<strong>"process"</strong>) your personal information when you use our services (<strong>"Services"</strong>), including when you:
                    </span>
                  </span>
                </span>
              </div>
              ...
              <ul>
                <li data-custom-class="body_text" style={{lineHeight: '1.5'}}>
                  <span style={{fontSize: '15px', color: 'rgb(89, 89, 89)'}}>
                    <span data-custom-class="body_text">
                      Visit our website at <a target="_blank" data-custom-class="link" href="https://www.autoseclabs.space/">https://www.autoseclabs.space/</a> or any website of ours that links to this Privacy Notice
                    </span>
                  </span>
                </li>
              </ul>
              ...
              <ul>
                <li data-custom-class="body_text" style={{lineHeight: '1.5'}}>
                  <span style={{fontSize: '15px'}}>
                    Use <strong>AutoSecLabs</strong>. <strong>AutoSecLabs is a cybersecurity-focused platform that provides quality assurance (QA), security testing, and automation solutions to help businesses protect their digital assets and improve system reliability.</strong>
                  </span>
                </li>
              </ul>
              ...
              <div style={{lineHeight: '1.5'}}>
                <span style={{fontSize: '15px'}}>
                  <span data-custom-class="body_text">
                    <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a target="_blank" data-custom-class="link" href="mailto:contact@autoseclabs.space">contact@autoseclabs.space</a>.
                  </span>
                </span>
              </div>
              ...
              <div style={{lineHeight: '1.5'}}>
                <span style={{fontSize: '15px'}}>
                  <span data-custom-class="body_text">
                    <strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a <a data-custom-class="link" href="https://app.termly.io/notify/03806dc8-15b4-4cfc-a309-192ccb93c092" rel="noopener noreferrer" target="_blank">data subject access request</a>, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
                  </span>
                </span>
              </div>
              ...
              <div style={{lineHeight: '1.5'}}>
                <span style={{fontSize: '15px'}}>
                  <span data-custom-class="body_text">
                    For the complete privacy policy with all sections including detailed information about data collection, processing, legal bases, sharing practices, AI products, data retention, security measures, privacy rights, and contact information, please refer to the full document.
                  </span>
                </span>
              </div>
              ...
              <div style={{lineHeight: '1.5'}}>
                <span style={{fontSize: '15px'}}>
                  <span data-custom-class="body_text">
                    ...
                    Email: <a data-custom-class="link" href="mailto:contact@autoseclabs.space">contact@autoseclabs.space</a><br />
                    Address: AutoSecLabs, Hyderabad, Telangana 500049, India
                  </span>
                </span>
              </div>
            </div>
